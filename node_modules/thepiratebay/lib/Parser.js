                ...
                requests = proxyUrls.map(function (_url) {
                  ...
                  return (
                    ...
                    (0, _isomorphicFetch2.default)(_url, options).then(function (response) {
                      ...
                      return body.includes('502: Bad gateway') || body.includes('403 Forbidden') || body.includes('Database maintenance') || body.includes('Origin DNS error') ? _promise2.default.reject('Database maintenance, Cloudflare DNS error, 403 or 502 error') : _promise2.default.resolve(body);
                    })
                  );
                });
